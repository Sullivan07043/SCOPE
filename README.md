...
git clone https://github.com/your-repo/scope-router.git
cd scope-router/opensource
...
- **SCOPE Predictor**: [Cooolder/SCOPE-CoT-RL-v3](https://huggingface.co/Cooolder/SCOPE-CoT-RL-v3)
